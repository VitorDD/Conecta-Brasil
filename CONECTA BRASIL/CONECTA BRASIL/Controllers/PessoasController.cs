...
namespace CONECTA_BRASIL.Controllers
{
    public class PessoasController : Controller
    {
        ...
        public PessoasController(CONECTA_BRASILContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Edit(int id, [Bind("BirthDate,Interesse,Id,Name,Email,Telefone,Senha")] Pessoa pessoa)
        {
            if (id != pessoa.Id)
            {
                return NotFound();
